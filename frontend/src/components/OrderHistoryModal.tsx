...
import { History, CheckSquare, Edit, Loader2 } from "lucide-react";
...
export function OrderHistoryModal({
    ...
    const { data: confirmationDetails, isLoading: loadingConfirmations } =
        useQuery({
                    ...
                    <Tabs defaultValue="changes">
                        <TabsList className="grid w-full grid-cols-2">
                            ...
                            >
                                ...
                                Confirmations (
                                {confirmationDetails?.confirmations?.length ||
                                    0}
                                )
                            </TabsTrigger>
                        </TabsList>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {confirmationDetails?.summary && (
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-muted rounded-lg">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-semibold">
                                                    {confirmationDetails.summary.yield_efficiency?.toFixed(
                                                        1
                                                    )}
                                                    %
                                                </p>
                                            ...
                                            <div>
                                                ...
                                                <p className="font-semibold">
                                                    {confirmationDetails.summary.time_efficiency?.toFixed(
                                                        1
                                                    )}
                                                    %
                                                </p>
                                    ...
                                    <div className="rounded-lg border">
                                        <Table>
                                            ...
                                            <TableBody>
                                                {confirmationDetails?.confirmations?.map(
                                                    (
                                                        conf: OperationConfirmation
                                                    ) => (
                                                        <TableRow
                                                            key={
